...
import { createChat } from "components/chatbot/apis";
...
function ChatSuggestions() {
  ...
  return (
    <SuggestionsContainer>
      ...
      <Note>
        <strong>Note:</strong> Try to ask about specific themes and dimensions.
        Eg. "What people were saying about [Updates] in [September]". You can
        also refer to the{" "}
        <a href="/" target="blank">
          Example question
        </a>{" "}
